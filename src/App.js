...
import { json, geoEqualEarth, geoPath, scaleSqrt } from 'd3';
...
const cordinateJson = "https://gist.githubusercontent.com/erdem/8c7d26765831d0f9a8c62f02782ae00d/raw/248037cd701af0a4957cce340dabb0fd04e38f4c/countries.json"
...
export function App() {
  ...
  const [position, setPosition] =useState(cities);
  ...
  const hexbin_convert = hexbin().extent([[0, 0], [900, 520]]).radius(10)



  return (
    <div>
    <svg id='map' width={900} height={520}>
